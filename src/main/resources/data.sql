...
INSERT INTO users(login, password, email, enabled, role_id) VALUES
    ('user', '$2a$10$Pef2YReykJBsFlPMiQDN/Osuw.giwWfpmOWDfJV0MRV6QK.SMr7uu', 'mail@gmail.com', true,
        SELECT id FROM roles WHERE role_name = 'ROLE_USER'),
    ('admin', '$2a$10$kb6QF30IUX.S2GmzoWLUFOCnf/UBzP1nJ73P2/g8nsC6FY6o9Jd/2', 'mail.net@gmail.com', true,
...
INSERT INTO tasks(title, description, priority, status, deadline, category_id) VALUES
    ...
    ('Stworzyć aplikację', 'Aplikacja To-Do List', 'HIGH', 'IN_PROGRESS', '2021-04-10',
        SELECT id FROM categories WHERE category_name = 'Work'),
    ('Ukończyć kurs ''Spring - zadania''', 'Kurs programowania z javastart.pl', 'HIGH', 'COMPLETED', '2021-03-24',
        SELECT id FROM categories WHERE category_name = 'Work'),
